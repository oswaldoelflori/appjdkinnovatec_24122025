...
class Usuario
{
    ...
    public function insertar($nombre,$tipo_documento,$num_documento,$direccion,$telefono,$email,$cargo,$login,$clave,$imagen,$permisos)
    {
        ...
        $sql2 = "INSERT INTO contacto (nombre, apellido, dni, email, celular, whatsapp, tipo) 
                 VALUES ('$firstName', '$lastName', '$num_documento', '$email', '$telefono', '$telefono', '2')";
    ...
    {
        $sql = "SELECT * FROM usuario WHERE cargo='EMPLEADO'";
        return ejecutarConsulta($sql);
    }
