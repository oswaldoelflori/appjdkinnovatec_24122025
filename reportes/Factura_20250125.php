...
$this->Cell(18,5, utf8_decode($tipomoneda),1,0, 'R', false);
        ...
        $this->Cell(31,5, utf8_decode($forma_pago),1,0, 'L', false);
...
$this->Ln(5);
$this->SetFont('arial','',7);
$this->Cell(20,5,'VENDEDOR:',1,0,'L', false);
$this->Cell(25,5,$usuario  , 1, 0, 'L', false);
$this->Cell(143,5, utf8_decode($observacion),1,0, 'L', false);
...
function addCadreTVAs($nombre_empresa,$monto,$bcpsoles,$bcpdolares,$cuentadetracciones)
{
	...
	$this->MultiCell(130,4, 'SON: ' .$monto);
